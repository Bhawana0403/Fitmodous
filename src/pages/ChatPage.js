...
function ChatPage(){
 ...
 Personal Member
          ...
          <img  style={{borderRadius:"20px",paddingRight:"500px"}} src={Image}class="responsive" width="300px"
                     height="300px"/>
              <Typography  variant="subtitle2"style={{fontWeight:600,fontSize:"20px",color:"blue",paddingRight:"500px"}}>
Look at how bulge my arms
    </Typography>
    <br>
    </br>
    <Typography  variant="subtitle2"style={{fontWeight:600,fontSize:"20px",color:"black",paddingRight:"500px"}}>
Of course,let me know if your on your way
    </Typography>
    <br></br>
    <br></br>
    <Paper style={{backgroundColor:"blue",width:"300px",marginLeft:"600px",borderRadius:"20px",height:"100px"}}>
